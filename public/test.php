...
/*--------------------------------------------------
 ...
 | Copyright (c) 2004-2017 Fabr¨ªcio Seger Kolling
...
function get_client_ip() {
    ...
    // proxy transparente n?o esconde o IP local, colocando ele ap¨®s o IP da rede, separado por v¨ªrgula
...
function remove_special_chars($str){
    $str = trim($str);
    $str = strtr($str,"£¤¦Ì¨¤¨¢??????¨¨¨¦¨º?¨¬¨ª??D?¨°¨®????¨´¨²?¨¹Y?¨¤¨¢a?????¨¨¨¦¨º?¨¬¨ª??e?¨°¨®????¨´¨²?¨¹y?!@#%&*()[]{}+=?",
...
function config_form(){
    ...
    if ($reload){
        ...
        <select name=newlang style=\"width:406px\">
            ...
            <option value='ca'>Catalan - by Pere Borr¨¤s AKA @Norl
            ...
            <option value='pl'>Polish - by Jakub Koc¨®j           
            <option value='es'>Spanish - by Sh Studios
            <option value='ru'>Russian - by §¦§Ó§Ô§Ö§ß§Ú§Û §²§Ñ§ê§Ö§Ó, §¡§Ý§Ö§Ü§ã§Ö§Û §¤§Ñ§Ó§â§ð§ê§Ú§ß
...
function et($tag){
    ...
    $et['pt']['SaveConfig'] = 'Salvar Configura??es';
    ...
    $et['pt']['Configurations'] = 'Configura??es';
    $et['pt']['JSError'] = 'Erro de JavaScript';
    $et['pt']['NoSel'] = 'N?o h¨¢ itens selecionados';
    $et['pt']['SelDir'] = 'Selecione o diret¨®rio de destino na ¨¢rvore a esquerda';
    $et['pt']['TypeDir'] = 'Digite o nome do diret¨®rio';
    ...
    $et['pt']['NoDestDir'] = 'N?o h¨¢ um diret¨®rio de destino selecionado';
    $et['pt']['DestEqOrig'] = 'Diret¨®rio de origem e destino iguais';
    $et['pt']['InvalidDest'] = 'Diret¨®rio de destino inv¨¢lido';
    $et['pt']['NoNewPerm'] = 'Nova permiss?o n?o foi setada';
    $et['pt']['CopyTo'] = 'COPIAR para';
    $et['pt']['MoveTo'] = 'MOVER para';
    $et['pt']['AlterPermTo'] = 'ALTERAR PERMISS?ES para';
    $et['pt']['ConfExec'] = 'Confirma EXECUTAR';
    $et['pt']['ConfRem'] = 'Confirma APAGAR';
    $et['pt']['EmptyDir'] = 'Diret¨®rio vazio';
    $et['pt']['IOError'] = 'Erro de E/S';
    $et['pt']['FileMan'] = 'PHP File Manager';
    $et['pt']['TypePass'] = 'Digite a senha';
    $et['pt']['InvPass'] = 'Senha Inv¨¢lida';
    $et['pt']['ReadDenied'] = 'Acesso de leitura negado';
    $et['pt']['FileNotFound'] = 'Arquivo n?o encontrado';
    $et['pt']['AutoClose'] = 'Fechar Automaticamente';
    $et['pt']['OutDocRoot'] = 'Arquivo fora do DOCUMENT_ROOT';
    $et['pt']['NoCmd'] = 'Erro: Comando n?o informado';
    $et['pt']['ConfTrySave'] = 'Arquivo sem permiss?o de escrita.\\nTentar salvar assim mesmo';
    $et['pt']['ConfSaved'] = 'Configura??es salvas';
    $et['pt']['PassSaved'] = 'Senha salva';
    $et['pt']['FileDirExists'] = 'Arquivo ou diret¨®rio j¨¢ existe';
    $et['pt']['NoPhpinfo'] = 'Fun??o phpinfo desabilitada';
    $et['pt']['NoReturn'] = 'sem retorno';
    $et['pt']['FileSent'] = 'Arquivo enviado';
    $et['pt']['SpaceLimReached'] = 'Limite de espa?o alcan?ado';
    $et['pt']['InvExt'] = 'Extens?o inv¨¢lida';
    $et['pt']['FileNoOverw'] = 'Arquivo n?o pode ser sobreescrito';
    $et['pt']['FileOverw'] = 'Arquivo sobreescrito';
    $et['pt']['FileIgnored'] = 'Arquivo omitido';
    $et['pt']['ChkVer'] = 'Verificar por nova vers?o';
    $et['pt']['ChkVerAvailable'] = 'Nova vers?o, clique aqui para iniciar download!!';
    $et['pt']['ChkVerNotAvailable'] = 'N?o h¨¢ nova vers?o dispon¨ªvel. :(';
    $et['pt']['ChkVerError'] = 'Erro de conex?o.';
    ...
    $et['pt']['Total'] = 'total';
    $et['pt']['Partition'] = 'Parti??o';
    $et['pt']['RenderTime'] = 'Tempo para gerar esta p¨¢gina';
    $et['pt']['Seconds'] = 'seg';
    $et['pt']['ErrorReport'] = 'Error Reporting';

    // Polish - by Jakub Koc¨®j
    ...
    $et['pl']['Enter'] = 'Enter';
    $et['pl']['Send'] = 'Wy?lij';
    $et['pl']['Refresh'] = 'Od?wie?';
    $et['pl']['SaveConfig'] = 'Zapisz konfiguracj?';
    ...
    $et['pl']['CreateDir'] = 'Utw¨®rz katalog';
    $et['pl']['CreateArq'] = 'Ut¨®wrz plik';
    $et['pl']['ExecCmd'] = 'Wykonaj polecenie';
    $et['pl']['Upload'] = 'Wgraj plik';
    $et['pl']['UploadEnd'] = 'Wgranie zako¨½czone';
    $et['pl']['Perm'] = 'Prawa pliku';
    $et['pl']['Perms'] = 'Prawa dost?pu';
    $et['pl']['Owner'] = 'W?a?ciciel';
    $et['pl']['Group'] = 'Grupa';
    $et['pl']['Other'] = 'Inne';
    $et['pl']['Size'] = 'Rozmiar';
    $et['pl']['Date'] = 'Data';
    ...
    $et['pl']['JSError'] = 'B??d JavaScript';
    $et['pl']['NoSel'] = 'Nie wybrano ?adnych rekord¨®w';
    $et['pl']['SelDir'] = 'Wybierz docelowy folder w drzewku po lewej';
    $et['pl']['TypeDir'] = 'Wpisz nazw? folderu';
    $et['pl']['TypeArq'] = 'Wpisz nazw? pliku';
    $et['pl']['TypeCmd'] = 'Wprowad? komend?';
    $et['pl']['TypeArqComp'] = 'Wprowad? nazw? pliku.\\nRozszerzenie definiuje kompresj? pliku.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['pl']['RemSel'] = 'USU? zanzaczone rekordy';
    $et['pl']['NoDestDir'] = 'Nie wybrano folderu docelowego';
    $et['pl']['DestEqOrig'] = 'Folder docelowy jest r¨®wny bie??cemu folderowi';
    $et['pl']['InvalidDest'] = 'Folder docelowy jest niepoprawny';
    $et['pl']['NoNewPerm'] = 'Nie ustawiono uprawnie¨½';
    $et['pl']['CopyTo'] = 'KOPIUJ do';
    $et['pl']['MoveTo'] = 'PRZENIE? do';
    $et['pl']['AlterPermTo'] = 'ZMIE? PRAWA DOST?PU do';
    $et['pl']['ConfExec'] = 'Potwierd? WYKONANIE POLECENIA';
    $et['pl']['ConfRem'] = 'Potwierd? USUNI?CIE';
    $et['pl']['EmptyDir'] = 'Pusty folder';
    $et['pl']['IOError'] = 'B??d wej?cia/wyj?cia';
    $et['pl']['FileMan'] = 'PHP Menad?er plik¨®w';
    $et['pl']['InvPass'] = 'Niepoprawne has?o';
    $et['pl']['ReadDenied'] = 'Czytanie dost?p zabroniony';
    $et['pl']['FileNotFound'] = 'Nie odnaleziono pliku';
    $et['pl']['AutoClose'] = 'Zamknij po zako¨½czeniu';
    $et['pl']['OutDocRoot'] = 'Plik powy?ej DOCUMENT_ROOT';
    $et['pl']['NoCmd'] = 'B??d: Brak polecenia';
    $et['pl']['ConfTrySave'] = 'Plik bez mo?liwo?ci zapisy.\\nSpr¨®b¨®j zapisa? pomimo tego';
    $et['pl']['ConfSaved'] = 'Konfiguracja zapisana';
    $et['pl']['PassSaved'] = 'Has?o zapisane';
    $et['pl']['FileDirExists'] = 'Plik lub folder ju? istnieje';
    $et['pl']['NoPhpinfo'] = 'Funkcja phpinfo wy??czona';
    $et['pl']['NoReturn'] = 'bez powrotu';
    $et['pl']['FileSent'] = 'Plik wys?ano';
    $et['pl']['SpaceLimReached'] = 'Osi?gni?to limit miejsa';
    $et['pl']['InvExt'] = 'Niepoprawne rozszerzenie';
    $et['pl']['FileNoOverw'] = 'Plik nie mo?e zosta? nadpisany';
    $et['pl']['FileOverw'] = 'Nadpisano plik';
    $et['pl']['FileIgnored'] = 'Plik pomini?te';
    $et['pl']['ChkVer'] = 'Sprawd? aktualizacje';
    $et['pl']['ChkVerAvailable'] = 'Jest nowa wersja, klikniu tutaj aby pobra?!!';
    $et['pl']['ChkVerNotAvailable'] = 'Brak nowszej wersji. :(';
    $et['pl']['ChkVerError'] = 'B??d po??czenia.';
    $et['pl']['Website'] = 'Strona';
    $et['pl']['SendingForm'] = 'Pliki s? przesy?ane, prosz? czeka?';
    $et['pl']['NoFileSel'] = 'Nie wybrano pliku';
    $et['pl']['SelAll'] = 'Wszystkie';
    $et['pl']['SelNone'] = '?adme';
    $et['pl']['SelInverse'] = 'Odwr¨®? zaznaczenie';
    ...
    $et['pl']['Seconds'] = 'sec';
    $et['pl']['ErrorReport'] = 'Raportowanie b??d¨®w';
    $et['pl']['Close'] = 'Zamknij';
    $et['pl']['SetPass'] = 'Ustaw has?o';
    $et['pl']['ChangePass'] = 'Zmie¨½ has?o';
    $et['pl']['Portscan'] = 'Skan port¨®w';    

    // Spanish - by Sh Studios
    $et['es']['Version'] = 'Versi¨®n';
    ...
    $et['es']['SavePass'] = 'Cuardar Contrase?a';
    ...
    $et['es']['TypePass'] = 'Escriba la contrase?a';
    $et['es']['InvPass'] = 'Contrase?a invalida';
    ...
    $et['es']['PassSaved'] = 'Contrase?a guardada';
    ...
    $et['ko']['FileNotFound'] = '??? ????';
    $et['ko']['AutoClose'] = '??? ??';
    $et['ko']['OutDocRoot'] = 'DOCUMENT_ROOT ??? ??? ????';
    $et['ko']['NoCmd'] = '??: ??? ???? ?????';
    $et['ko']['ConfTrySave'] = '??? ?? ??? ????.\\n??? ????????';
    $et['ko']['ConfSaved'] = '??? ???????';
    $et['ko']['PassSaved'] = '???? ??';
    $et['ko']['FileDirExists'] = '?? ?? ????? ?? ?????';
    $et['ko']['NoPhpinfo'] = 'PHPINFO()? ???? ????';
    $et['ko']['NoReturn'] = '??? ??';
    $et['ko']['FileSent'] = '?? ??';
    $et['ko']['SpaceLimReached'] = '???? ??? ????';
    $et['ko']['InvExt'] = '???? ?? ???';
    $et['ko']['FileNoOverw'] = '??? ?? ?? ????';
    $et['ko']['FileOverw'] = '??? ?? ????';
    $et['ko']['FileIgnored'] = '??? ???????';
    $et['ko']['ChkVer'] = '?? ??? ??';
    $et['ko']['ChkVerAvailable'] = '??? ??? ????. ?????? ?????!!';
    $et['ko']['ChkVerNotAvailable'] = '??? ??? ????. :(';
    $et['ko']['ChkVerError'] = '?? ??';
    $et['ko']['Website'] = '????';
    $et['ko']['SendingForm'] = '??? ??????. ?????';
    $et['ko']['NoFileSel'] = '??? ???? ?????';
    ...
    $et['de']['Exec'] = 'Ausf¨¹hren';
    $et['de']['Apply'] = 'Best?tigen';
    ...
    $et['de']['RemSel'] = 'L?SCHE die selektierten Objekte';
    $et['de']['NoDestDir'] = 'Das selektierte Zielverzeichnis existiert nicht';
    $et['de']['DestEqOrig'] = 'Quell- und Zielverzeichnis stimmen ¨¹berein';
    $et['de']['InvalidDest'] = 'Zielverzeichnis ist ung¨¹ltig';
    $et['de']['NoNewPerm'] = 'Neue Zugriffserlaubnis konnte nicht gesetzt werden';
    $et['de']['CopyTo'] = 'KOPIERE nach';
    $et['de']['MoveTo'] = 'VERSCHIEBE nach';
    $et['de']['AlterPermTo'] = '?NDERE ZUGRIFFSERLAUBSNIS in';
    $et['de']['ConfExec'] = 'Best?tige AUSF¨¹HRUNG';
    $et['de']['ConfRem'] = 'Best?tige L?SCHEN';
    ...
    $et['de']['InvPass'] = 'Ung¨¹ltiges Passwort';
    $et['de']['ReadDenied'] = 'Lesezugriff verweigert';
    $et['de']['FileNotFound'] = 'Datei nicht gefunden';
    $et['de']['AutoClose'] = 'Schlie?en, wenn fertig';
    $et['de']['OutDocRoot'] = 'Datei au?erhalb von DOCUMENT_ROOT';
    $et['de']['NoCmd'] = 'Fehler: Es wurde kein Kommando eingetragen';
    $et['de']['ConfTrySave'] = 'Keine Schreibberechtigung f¨¹r die Datei.\\nVersuche trotzdem zu speichern';
    ...
    $et['de']['NoReturn'] = 'keine R¨¹ckgabe';
    $et['de']['FileSent'] = 'Datei wurde gesendet';
    $et['de']['SpaceLimReached'] = 'Verf¨¹gbares Speicherlimit wurde erreicht';
    $et['de']['InvExt'] = 'Ung¨¹ltige Dateiendung';
    $et['de']['FileNoOverw'] = 'Datei kann nicht ¨¹berschrieben werden';
    $et['de']['FileOverw'] = 'Datei ¨¹berschrieben';
    $et['de']['FileIgnored'] = 'Datei ignoriert';
    $et['de']['ChkVer'] = 'Pr¨¹fe auf neue Version';
    $et['de']['ChkVerAvailable'] = 'Neue Version verf¨¹gbar; klicke hier, um den Download zu starten!!';
    ...
    $et['de2']['NoSel'] = 'Keine Eintr?ge ausgew?hlt';
    $et['de2']['SelDir'] = 'W?hlen Sie das Zeilverzeichnis im Verzeichnis links';
    ...
    $et['de2']['InvPass'] = 'Ung¨¹ltiges Passwort';
    ...
    $et['de2']['NoReturn'] = 'keine R¨¹ckgabe';
    $et['de2']['FileSent'] = 'Datei versandt';
    $et['de2']['SpaceLimReached'] = 'Plattenplatz ersch?pft';
    $et['de2']['InvExt'] = 'Ung¨¹ltige datei-Extension';
    $et['de2']['FileNoOverw'] = 'Datei kann nicht ¨¹berschrieben werden';
    $et['de2']['FileOverw'] = 'Datei ¨¹berschrieben';
    $et['de2']['FileIgnored'] = 'Datei ignoriert';
    $et['de2']['ChkVer'] = '¨¹berpr¨¹fe neuer Version';
    $et['de2']['ChkVerAvailable'] = 'Neue Version. Hier klicken f¨¹r Download!!';
    $et['de2']['ChkVerNotAvailable'] = 'Keine neue Version verf¨¹gbar. :(';
    $et['de2']['ChkVerError'] = 'Verbindungsfehler.';
    $et['de2']['Website'] = 'Webseite';
    $et['de2']['SendingForm'] = 'Sende Dateien, bitte warten';
    $et['de2']['NoFileSel'] = 'Keine Dateien ausgew?hlt';
    $et['de2']['SelAll'] = 'Alle';
    $et['de2']['SelNone'] = 'Keine';
    $et['de2']['SelInverse'] = 'Invers';
    $et['de2']['Selected_s'] = 'ausgew?hlt';
    $et['de2']['Total'] = 'Total';
    ...
    $et['fr']['CreateDir'] = 'Cr¨¦er un r¨¦pertoire';
    $et['fr']['CreateArq'] = 'Cr¨¦er un fichier';
    $et['fr']['ExecCmd'] = 'Executer une Commande';
    $et['fr']['Upload'] = 'T¨¦l¨¦versement(upload)';
    $et['fr']['UploadEnd'] = 'T¨¦l¨¦versement Fini';
    $et['fr']['Perm'] = 'Perm';
    $et['fr']['Perms'] = 'Permissions';
    $et['fr']['Owner'] = 'Propri¨¦taire';
    $et['fr']['Group'] = 'Groupe';
    $et['fr']['Other'] = 'Autre';
    $et['fr']['Size'] = 'Taille';
    $et['fr']['Date'] = 'Date';
    ...
    $et['fr']['Dir_s'] = 'r¨¦pertoire(s)';
    $et['fr']['To'] = '¨¤';
    $et['fr']['Destination'] = 'Destination';
    $et['fr']['Configurations'] = 'Configurations';
    $et['fr']['JSError'] = 'Erreur JavaScript';
    $et['fr']['NoSel'] = 'Rien n\'est s¨¦lectionn¨¦';
    $et['fr']['SelDir'] = 'Selectionnez le r¨¦pertoire de destination dans le panneau gauche';
    $et['fr']['TypeDir'] = 'Entrer le nom du r¨¦pertoire';
    ...
    $et['fr']['RemSel'] = 'EFFACER les objets s¨¦lectionn¨¦s';
    $et['fr']['NoDestDir'] = 'Aucun r¨¦pertoire de destination n\'est s¨¦lectionn¨¦';
    $et['fr']['DestEqOrig'] = 'Les r¨¦pertoires source et destination sont identiques';
    $et['fr']['InvalidDest'] = 'Le r¨¦pertoire de destination est invalide';
    $et['fr']['NoNewPerm'] = 'Nouvelle permission non ¨¦tablie';
    ...
    $et['fr']['EmptyDir'] = 'R¨¦pertoire vide';
    ...
    $et['fr']['ReadDenied'] = 'Droit de lecture refus¨¦';
    $et['fr']['FileNotFound'] = 'Fichier introuvable';
    $et['fr']['AutoClose'] = 'Fermer sur fin';
    $et['fr']['OutDocRoot'] = 'Fichier au del¨¤ de DOCUMENT_ROOT';
    $et['fr']['NoCmd'] = 'Erreur: Commande non renseign¨¦e';
    $et['fr']['ConfTrySave'] = 'Fichier sans permission d\'¨¦criture.\\nJ\'essaie de l\'enregister';
    $et['fr']['ConfSaved'] = 'Configurations enreristr¨¦e';
    $et['fr']['PassSaved'] = 'Mot de passe enreristr¨¦';
    $et['fr']['FileDirExists'] = 'Le fichier ou le r¨¦pertoire existe d¨¦j¨¤';
    $et['fr']['NoPhpinfo'] = 'Function phpinfo d¨¦sactiv¨¦e';
    $et['fr']['NoReturn'] = 'pas de retour';
    $et['fr']['FileSent'] = 'Fichier envoy¨¦';
    $et['fr']['SpaceLimReached'] = 'Espace maxi atteint';
    $et['fr']['InvExt'] = 'Extension invalide';
    $et['fr']['FileNoOverw'] = 'Le fichier ne peut pas etre ¨¦cras¨¦';
    $et['fr']['FileOverw'] = 'Fichier ¨¦cras¨¦';
    $et['fr']['FileIgnored'] = 'Fichier ignor¨¦';
    $et['fr']['ChkVer'] = 'Verifier nouvelle version';
    $et['fr']['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour la t¨¦l¨¦chager!!';
    ...
    $et['fr']['NoFileSel'] = 'Aucun fichier s¨¦lectionn¨¦';
    $et['fr']['SelAll'] = 'Tous';
    $et['fr']['SelNone'] = 'Aucun';
    $et['fr']['SelInverse'] = 'Inverser';
    $et['fr']['Selected_s'] = 'selection¨¦';
    $et['fr']['Total'] = 'total';
    ...
    $et['fr2']['Decompress'] = 'D¨¦compresser';
    $et['fr2']['ResolveIDs'] = 'R¨¦soudre ID';
    $et['fr2']['Move'] = 'D¨¦placer';
    $et['fr2']['Copy'] = 'Copier';
    $et['fr2']['ServerInfo'] = 'Information Serveur';
    $et['fr2']['CreateDir'] = 'Cr¨¦er un r¨¦pertoire';
    $et['fr2']['CreateArq'] = 'Cr¨¦er un fichier';
    $et['fr2']['ExecCmd'] = 'Execut¨¦ une commande';
    $et['fr2']['Upload'] = 'Transf¨¦rer';
    $et['fr2']['UploadEnd'] = 'Transfert termin¨¦';
    $et['fr2']['Perm'] = 'Perm';
    $et['fr2']['Perms'] = 'Permissions';
    $et['fr2']['Owner'] = 'Propri¨¦taire';
    $et['fr2']['Group'] = 'Groupe';
    $et['fr2']['Other'] = 'Autre';
    $et['fr2']['Size'] = 'Taille';
    $et['fr2']['Date'] = 'date';
    ...
    $et['fr2']['Dir_s'] = 'r¨¦pertoire(s)';
    $et['fr2']['To'] = '¨¤';
    $et['fr2']['Destination'] = 'Destination';
    $et['fr2']['Configurations'] = 'Configurations';
    $et['fr2']['JSError'] = 'Erreur JavaScript';
    $et['fr2']['NoSel'] = 'Il n\'y a pas d\'objets s¨¦lectionn¨¦s';
    $et['fr2']['SelDir'] = 'S¨¦lectionnez le r¨¦pertoire de destination sur l\'arborescence de gauche';
    $et['fr2']['TypeDir'] = 'Entrez le nom du r¨¦pertoire';
    $et['fr2']['TypeArq'] = 'Entrez le nom du fichier';
    $et['fr2']['TypeCmd'] = 'Entrez la commande';
    $et['fr2']['TypeArqComp'] = 'Entrez le fichier.\\nL\'extension d¨¦finira le type de compression.\\nEx:\\nnom.zip\\nnom.tar\\nnom.bzip\\nnom.gzip';
    $et['fr2']['RemSel'] = 'EFFACEZ l\'objet s¨¦lectionn¨¦';
    $et['fr2']['NoDestDir'] = 'Il n\'y a aucun r¨¦pertoire de destination s¨¦lectionn¨¦';
    $et['fr2']['DestEqOrig'] = 'Origine et r¨¦pertoires de destination sont identique';
    $et['fr2']['InvalidDest'] = 'R¨¦pertoire de destination est invalide';
    $et['fr2']['NoNewPerm'] = 'Nouvelle autorisation n\'a pas ¨¦t¨¦ configur¨¦';
    $et['fr2']['CopyTo'] = 'COPIE dans';
    $et['fr2']['MoveTo'] = 'D¨¦PLACER dans';
    $et['fr2']['AlterPermTo'] = 'CHANGER PERMISSIONS dans';
    $et['fr2']['ConfExec'] = 'Confirmer EXECUTE';
    $et['fr2']['ConfRem'] = 'Confirmer EFFACER';
    $et['fr2']['EmptyDir'] = 'R¨¦pertoire vide';
    ...
    $et['fr2']['ReadDenied'] = 'Acc¨¨s en lecture refuser';
    $et['fr2']['FileNotFound'] = 'Fichier non-trouv¨¦';
    $et['fr2']['AutoClose'] = 'Fermez a la fin';
    $et['fr2']['OutDocRoot'] = 'Fichier au-del¨¤ DOCUMENT_ROOT';
    $et['fr2']['NoCmd'] = 'Erreur: Commande inconnue';
    $et['fr2']['ConfTrySave'] = 'Fichier sans permission d\'¨¦criture.\\nEssayez de sauver';
    $et['fr2']['ConfSaved'] = 'Configurations sauv¨¦e';
    $et['fr2']['PassSaved'] = 'Mot de passe sauv¨¦';
    $et['fr2']['FileDirExists'] = 'Fichier ou r¨¦pertoire d¨¦j¨¤ existant';
    $et['fr2']['NoPhpinfo'] = 'Function phpinfo d¨¦sactiv¨¦';
    $et['fr2']['NoReturn'] = 'sans retour possible';
    $et['fr2']['FileSent'] = 'Fichier envoy¨¦';
    $et['fr2']['SpaceLimReached'] = 'Limite de d\'espace atteint';
    $et['fr2']['InvExt'] = 'Extension invalide';
    $et['fr2']['FileNoOverw'] = 'Fichier ne peut pas ¨ºtre ¨¦cras¨¦';
    $et['fr2']['FileOverw'] = 'Fichier ¨¦cras¨¦';
    $et['fr2']['FileIgnored'] = 'Fichier ignor¨¦';
    $et['fr2']['ChkVer'] = 'Check nouvelle version';
    $et['fr2']['ChkVerAvailable'] = 'Nouvelle version, cliquez ici pour commencer le t¨¦l¨¦chargement!!';
    ...
    $et['fr2']['SendingForm'] = 'Envoye de fichier, s\'il vous pla?t patientez';
    $et['fr2']['NoFileSel'] = 'Aucun fichier s¨¦lectionn¨¦';
    $et['fr2']['SelAll'] = 'Tout';
    $et['fr2']['SelNone'] = 'Aucuns';
    $et['fr2']['SelInverse'] = 'Inverser';
    $et['fr2']['Selected_s'] = 's¨¦lectionn¨¦';
    $et['fr2']['Total'] = 'total';
    ...
    $et['fr3']['Dir_s'] = 'r¨¦pertoire(s)';
    $et['fr3']['To'] = '¨¤';
    $et['fr3']['Destination'] = 'Destination';
    $et['fr3']['Configurations'] = 'Configurations';
    $et['fr3']['JSError'] = 'Erreur JavaScript';
    $et['fr3']['NoSel'] = 'Aucun ¨¦l¨¦ment s¨¦lectionn¨¦';
    $et['fr3']['SelDir'] = "S¨¦lectionner le r¨¦pertoire de destination dans l'arboresence de gauchethe destination directory on the left tree";
    $et['fr3']['TypeDir'] = 'Indiquer le nom du r¨¦pertoire';
    $et['fr3']['TypeArq'] = 'Indiquer le nom du fichier';
    $et['fr3']['TypeCmd'] = 'Entrer une commande';
    $et['fr3']['TypeArqComp'] = "Indiquer le nom du fichier.\\nL'extension d¨¦finira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip";
    $et['fr3']['RemSel'] = "SUPPRIMER l'¨¦l¨¦ment s¨¦lectionn¨¦";
    $et['fr3']['NoDestDir'] = "Il n'y a pas de r¨¦pertoire destination s¨¦lectionn¨¦";
    $et['fr3']['DestEqOrig'] = 'R¨¦pertoire Origine et Destination sont identiques';
    $et['fr3']['InvalidDest'] = 'Le r¨¦pertoire de destination est invalide';
    $et['fr3']['NoNewPerm'] = 'Nouvelle permission non appliqu¨¦e';
    ...
    $et['fr3']['EmptyDir'] = 'R¨¦pertoire vide';
    $et['fr3']['IOError'] = 'Erreur entr¨¦e/sortie';
    $et['fr3']['FileMan'] = 'PHP File Manager';
    $et['fr3']['TypePass'] = 'Saisir le mot de passe';
    $et['fr3']['InvPass'] = 'Mot de passe invalide';
    $et['fr3']['ReadDenied'] = 'Acc¨¨s en lecture refus¨¦';
    $et['fr3']['FileNotFound'] = 'Fichier non trouv¨¦';
    $et['fr3']['AutoClose'] = 'Fermeture en fin de traitement';
    $et['fr3']['OutDocRoot'] = 'Fichier en dessous de DOCUMENT_ROOT';
    $et['fr3']['NoCmd'] = 'Erreur : Commande non renseign¨¦e';
    $et['fr3']['ConfTrySave'] = "Fichier sans permission d'¨¦criture.\\nTenter de sauver malgr¨¦ tout";
    $et['fr3']['ConfSaved'] = 'Configurations sauvegard¨¦e';
    $et['fr3']['PassSaved'] = 'Password sauvegard¨¦';
    $et['fr3']['FileDirExists'] = 'Fichier ou r¨¦pertoire d¨¦j¨¤ existant';
    $et['fr3']['NoPhpinfo'] = 'Fonction phpinfo disactiv¨¦e';
    $et['fr3']['NoReturn'] = 'pas de retour';
    $et['fr3']['FileSent'] = 'Fichier envoy¨¦';
    $et['fr3']['SpaceLimReached'] = 'Capacit¨¦ maximale atteinte';
    $et['fr3']['InvExt'] = 'Extension invalide';
    $et['fr3']['FileNoOverw'] = 'Fichier ne pouvant ¨ºtre remplac¨¦';
    $et['fr3']['FileOverw'] = 'Fichier remplac¨¦';
    $et['fr3']['FileIgnored'] = 'Fichier ignor¨¦';
    $et['fr3']['ChkVer'] = 'V¨¦rifier nouvelle version';
    $et['fr3']['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour commencer le t¨¦l¨¦chargement !';
    ...
    $et['fr3']['NoFileSel'] = 'Pas de fichier s¨¦lectionn¨¦';
    $et['fr3']['SelAll'] = 'Tous';
    $et['fr3']['SelNone'] = 'Aucun';
    $et['fr3']['SelInverse'] = 'Inverser';
    $et['fr3']['Selected_s'] = 's¨¦lectionn¨¦';
    $et['fr3']['Total'] = 'total';
    $et['fr3']['Partition'] = 'Partition';
    $et['fr3']['RenderTime'] = 'Temps n¨¦cessaire pour obtenir cette page';
    $et['fr3']['Seconds'] = 'sec';
    ...
    $et['it']['NoDestDir'] = 'LA directory di destinazione non ¨¨ stata selezionata';
    $et['it']['DestEqOrig'] = 'La directory di origine e di destinazione sono la stessa';
    $et['it']['InvalidDest'] = 'La directory di destinazione non ¨¨ valida';
    ...
    $et['it']['FileDirExists'] = 'Il file o la directory esiste gi¨¤';
    $et['it']['NoPhpinfo'] = 'La funzione phpinfo ¨¨ disabilitata';
    $et['it']['NoReturn'] = 'senza Return';
    $et['it']['FileSent'] = 'File inviato';
    $et['it']['SpaceLimReached'] = '¨¨ stato raggiunto il limite di spazio disponibile';
    $et['it']['InvExt'] = 'Estensione non valida';
    $et['it']['FileNoOverw'] = 'Il file non pu¨° essere sovrascritto';
    $et['it']['FileOverw'] = 'File sovrascritto';
    $et['it']['FileIgnored'] = 'File ignorato';
    $et['it']['ChkVer'] = 'Controlla se ¨¨ disponibile una nuova versione';
    $et['it']['ChkVerAvailable'] = '¨¨ disponibile una nuova versione: premi qui per scaricarla.';
    $et['it']['ChkVerNotAvailable'] = 'Non ¨¨ disponibile nessuna nuova versione. :(';
    ...
    $et['it2']['NoDestDir'] = 'Non ¨¨ stata selezionata la cartella di destinazione';
    $et['it2']['DestEqOrig'] = 'La cartella di origine e di destinazione coincidono';
    $et['it2']['InvalidDest'] = 'La cartella di destinazione non ¨¨ valida';
    ...
    $et['it2']['FileDirExists'] = 'Il file o la cartella esiste gi¨¤';
    ...
    $et['it4']['FileDirExists'] = 'Il file o la directory esistono gi¨¤';
    ...
    $et['it4']['FileNoOverw'] = 'Il file non pu¨° essere sovrascritto';
    ...
    // Russian - by §¦§Ó§Ô§Ö§ß§Ú§Û §²§Ñ§ê§Ö§Ó, §¡§Ý§Ö§Ü§ã§Ö§Û §¤§Ñ§Ó§â§ð§ê§Ú§ß
    $ru['Version']='§£§Ö§â§ã§Ú§ñ';
    $ru['DocRoot']='§¬§à§â§ß§Ö§Ó§Ñ§ñ §á§Ñ§á§Ü§Ñ';
    $ru['FLRoot']='§¬§à§â§ß§Ö§Ó§Ñ§ñ §á§Ñ§á§Ü§Ñ §æ§Ñ§Û§Ý§à§Ó§à§Ô§à §Þ§Ö§ß§Ö§Õ§Ø§Ö§â§Ñ';
    $ru['Name']='§ª§Þ§ñ';
    $ru['And']='§Ú';
    $ru['Enter']='§£§à§Û§ä§Ú';
    $ru['Send']='§°§ä§á§â§Ñ§Ó§Ú§ä§î';
    $ru['Refresh']='§°§Ò§ß§à§Ó§Ú§ä§î';
    $ru['SaveConfig']='§³§à§ç§â§Ñ§ß§Ú§ä§î §Ü§à§ß§æ§Ú§Ô§å§â§Ñ§è§Ú§ð';
    $ru['SavePass']='§³§à§ç§â§Ñ§ß§Ú§ä§î §á§Ñ§â§à§Ý§î';
    $ru['SaveFile']='§³§à§ç§â§Ñ§ß§Ú§ä§î §æ§Ñ§Û§Ý';
    $ru['Save']='§³§à§ç§â§Ñ§ß§Ú§ä§î';
    $ru['Leave']='§µ§Û§ä§Ú';
    $ru['Edit']='§ª§Ù§Þ§Ö§ß§Ú§ä§î';
    $ru['View']='§±§â§à§ã§Þ§à§ä§â';
    $ru['Config']='§¯§Ñ§ã§ä§â§à§Û§Ü§Ú';
    $ru['Ren']='§±§Ö§â§Ö§Ú§Þ§Ö§ß§à§Ó§Ñ§ä§î';
    $ru['Rem']='§µ§Õ§Ñ§Ý§Ú§ä§î';
    $ru['Compress']='§³§Ø§Ñ§ä§î';
    $ru['Decompress']='§²§Ñ§ã§á§Ñ§Ü§à§Ó§Ñ§ä§î';
    $ru['ResolveIDs']='§°§á§â§Ö§Õ§Ö§Ý§Ú§ä§î ID';
    $ru['Move']='§±§Ö§â§Ö§Þ§Ö§ã§ä§Ú§ä§î';
    $ru['Copy']='§¬§à§á§Ú§â§à§Ó§Ñ§ä§î';
    $ru['ServerInfo']='§ª§ß§æ§à §à §ã§Ö§â§Ó§Ö§â§Ö';
    $ru['CreateDir']='§³§à§Ù§Õ§Ñ§ä§î §á§Ñ§á§Ü§å';
    $ru['CreateArq']='§³§à§Ù§Õ§Ñ§ä§î §æ§Ñ§Û§Ý';
    $ru['ExecCmd']='§£§í§á§à§Ý§ß§Ú§ä§î';
    $ru['Upload']='§©§Ñ§Ô§â§å§Ù§Ú§ä§î';
    $ru['UploadEnd']='§©§Ñ§Ô§â§å§Ø§Ö§ß§à';
    $ru['Perm']='§±§â§Ñ§Ó§Ñ';
    $ru['Perms']='§²§Ñ§Ù§â§Ö§ê§Ö§ß§Ú§ñ';
    $ru['Owner']='§£§Ý§Ñ§Õ§Ö§Ý§Ö§è';
    $ru['Group']='§¤§â§å§á§á§Ñ';
    $ru['Other']='§¥§â§å§Ô§Ú§Ö';
    $ru['Size']='§²§Ñ§Ù§Þ§Ö§â';
    $ru['Date']='§¥§Ñ§ä§Ñ';
    $ru['Type']='§´§Ú§á';
    $ru['Free']='§³§Ó§à§Ò§à§Õ§ß§à';
    $ru['Shell']='§¬§à§Þ§Ñ§ß§Õ§ß§Ñ§ñ §ã§ä§â§à§Ü§Ñ';
    $ru['Read']='§¹§Ú§ä§Ñ§ä§î';
    $ru['Write']='§±§Ú§ã§Ñ§ä§î';
    $ru['Exec']='§£§í§á§à§Ý§ß§ñ§ä§î';
    $ru['Apply']='§±§â§Ú§Þ§Ö§ß§Ú§ä§î';
    ...
    $ru['Dir_s']='§±§Ñ§á§Ü§Ñ/§Ú';
    $ru['To']='§Ó';
    $ru['Destination']='§¬§à§ß§Ö§é§ß§Ñ§ñ §á§Ñ§á§Ü§Ñ';
    $ru['Configurations']='§¬§à§ß§æ§Ú§Ô§å§â§Ñ§è§Ú§ñ';
    $ru['JSError']='§°§ê§Ú§Ò§Ü§Ñ JavaScript';
    $ru['NoSel']='§¯§Ö§ä §Ó§í§Ò§â§Ñ§ß§ß§í§ç §ï§Ý§Ö§Þ§Ö§ß§ä§à§Ó';
    $ru['SelDir']='§£§í§Ò§Ö§â§Ú§ä§Ö §á§Ñ§á§Ü§å §ß§Ñ§Ù§ß§Ñ§é§Ö§ß§Ú§ñ §Ó §Ý§Ö§Ó§à§Þ §Õ§Ö§â§Ö§Ó§Ö';
    $ru['TypeDir']='§£§Ó§Ö§Õ§Ú§ä§Ö §Ú§Þ§ñ §á§Ñ§á§Ü§Ú';
    $ru['TypeArq']='§£§Ó§Ö§Õ§Ú§ä§Ö §Ú§Þ§ñ §æ§Ñ§Û§Ý§Ñ';
    $ru['TypeCmd']='§£§Ó§Ö§Õ§Ú§ä§Ö §Ü§à§Þ§Ñ§ß§Õ§å';
    $ru['TypeArqComp']='§£§Ó§Ö§Õ§Ú§ä§Ö §Ú§Þ§ñ §Ú §â§Ñ§ã§ê§Ú§â§Ö§ß§Ú§Ö §æ§Ñ§Û§Ý§Ñ.\\n§²§Ñ§ã§ê§Ú§â§Ö§ß§Ú§Ö §à§á§â§Ö§Õ§Ö§Ý§Ú§ä §ä§Ú§á §ã§Ø§Ñ§ä§Ú§ñ.\\n §±§â§Ú§Þ§Ö§â: \\n nome.zip \\n nome.tar \\n nome.bzip \\n nome.gzip ';
    $ru['RemSel']='§µ§Õ§Ñ§Ý§Ú§ä§î §Ó§í§Ò§â§Ñ§ß§ß§í§Ö §ï§Ý§Ö§Þ§Ö§ß§ä§í';
    $ru['NoDestDir']='§¯§Ö §Ó§í§Ò§â§Ñ§ß§Ñ §á§Ñ§á§Ü§Ñ §ß§Ñ§Ù§ß§Ñ§é§Ö§ß§Ú§ñ';
    $ru['DestEqOrig']='§ª§ã§ç§à§Õ§ß§í§Ö §Ú §Ü§à§ß§Ö§é§ß§í§Ö §á§Ñ§á§Ü§Ú §â§Ñ§Ó§ß§í';
    $ru['InvalidDest']='§¬§à§ß§Ö§é§ß§Ñ§ñ §á§Ñ§á§Ü§Ñ §ß§Ö§Õ§Ö§Û§ã§ä§Ó§Ú§ä§Ö§Ý§î§ß§Ñ';
    $ru['NoNewPerm']='§¯§à§Ó§í§Ö §â§Ñ§Ù§â§Ö§ê§Ö§ß§Ú§ñ §ß§Ö §å§ã§ä§Ñ§ß§à§Ó§Ý§Ö§ß§í';
    $ru['CopyTo']='§¬§à§á§Ú§â§à§Ó§Ñ§ä§î §Ó';
    $ru['MoveTo']='§±§Ö§â§Ö§Þ§Ö§ã§ä§Ú§ä§î §Ó';
    $ru['AlterPermTo']='§ª§Ù§Þ§Ö§ß§Ö§ß§Ú§ä§î §â§Ñ§Ù§â§Ö§ê§Ö§ß§Ú§ñ §ß§Ñ';
    $ru['ConfExec']='§±§à§Õ§ä§Ó§Ö§â§Õ§Ú§ä§î §£§½§±§°§­§¯§¦§¯§ª§¦';
    $ru['ConfRem']='§±§à§Õ§ä§Ó§Ö§â§Õ§Ú§ä§î §µ§¥§¡§­§¦§¯§ª§¦';
    $ru['EmptyDir']='§±§å§ã§ä§Ñ§ñ §á§Ñ§á§Ü§Ñ';
    $ru['IOError']='§°§ê§Ú§Ò§Ü§Ñ I/O';
    $ru['FileMan']='§¶§Ñ§Û§Ý§à§Ó§í§Û §Þ§Ö§ß§Ö§Õ§Ø§Ö§â';
    $ru['TypePass']='§£§Ó§Ö§Õ§Ú§ä§Ö §á§Ñ§â§à§Ý§î';
    $ru['InvPass']='§¯§Ö§Ó§Ö§â§ß§í§Û §á§Ñ§â§à§Ý§î';
    $ru['ReadDenied']='§¥§à§ã§ä§å§á §Ù§Ñ§á§â§Ö§ë§Ö§ß';
    $ru['FileNotFound']='§¶§Ñ§Û§Ý §ß§Ö §ß§Ñ§Û§Õ§Ö§ß';
    $ru['AutoClose']='§©§Ñ§Ü§â§í§ä§î §á§à§ã§Ý§Ö §à§Ü§à§ß§é§Ñ§ß§Ú§ñ';
    $ru['OutDocRoot']='§¶§Ñ§Û§Ý§í §Ù§Ñ §á§â§Ö§Õ§Ö§Ý§Ñ§Þ§Ú DOCUMENT_ROOT';
    $ru['NoCmd']='§°§ê§Ú§Ò§Ü§Ñ: §¬§à§Þ§Ñ§ß§Õ§Ñ §ß§Ö §á§à§Õ§Õ§Ö§â§Ø§Ú§Ó§Ñ§Ö§ä§ã§ñ';
    $ru['ConfTrySave']='§¶§Ñ§Û§Ý §Ò§Ö§Ù §á§â§Ñ§Ó §ß§Ñ §Ù§Ñ§á§Ú§ã§î.\\n§±§à§á§í§ä§Ñ§ä§î§ã§ñ §ã§à§ç§â§Ñ§ß§Ú§ä§î';
    $ru['ConfSaved']='§¬§à§ß§æ§Ú§Ô§å§â§Ñ§è§Ú§ñ §ã§à§ç§â§Ñ§ß§Ö§ß§Ñ';
    $ru['PassSaved']='§±§Ñ§â§à§Ý§î §ã§à§ç§â§Ñ§ß§Ö§ß';
    $ru['FileDirExists']='§¶§Ñ§Û§Ý §Ú§Ý§Ú §á§Ñ§á§Ü§Ñ §å§Ø§Ö §ã§å§ë§Ö§ã§ä§Ó§å§Ö§ä';
    $ru['NoPhpinfo']='§¶§å§ß§Ü§è§Ú§ñ PHPInfo §à§ä§Ü§Ý§ð§é§Ö§ß§Ñ';
    $ru['NoReturn']='§¯§Ö§ä §Ó§à§Ù§Ó§â§Ñ§ä§Ñ';
    $ru['FileSent']='§¶§Ñ§Û§Ý §à§ä§á§â§Ñ§Ó§Ý§Ö§ß';
    $ru['SpaceLimReached']='§±§Ñ§Þ§ñ§ä§î §á§à§Ý§ß§à§ã§ä§î§ð §Ù§Ñ§á§à§Ý§ß§Ö§ß§Ñ';
    $ru['InvExt']='§¯§Ö§Õ§Ö§Û§ã§ä§Ó§Ú§ä§Ö§Ý§î§ß§à§Ö §â§Ñ§ã§ê§Ú§â§Ö§ß§Ú§Ö';
    $ru['FileNoOverw']='§¶§Ñ§Û§Ý §ß§Ö §Þ§à§Ø§Ö§ä §Ò§í§ä§î §á§Ö§â§Ö§Ù§Ñ§á§Ú§ã§Ñ§ß';
    $ru['FileOverw']='§¶§Ñ§Û§Ý §á§Ö§â§Ö§Ù§Ñ§á§Ú§ã§Ñ§ß';
    $ru['FileIgnored']='§¶§Ñ§Û§Ý §Ú§Ô§ß§à§â§Ú§â§à§Ó§Ñ§ß';
    $ru['ChkVer']='§±§à§Ú§ã§Ü §à§Ò§ß§à§Ó§Ý§Ö§ß§Ú§Û';
    $ru['ChkVerAvailable']=' §¥§à§ã§ä§å§á§ß§Ñ §ß§à§Ó§Ñ§ñ §Ó§Ö§â§ã§Ú§ñ; §ß§Ñ§Ø§Þ§Ú§ä§Ö §Ù§Õ§Ö§ã§î, §é§ä§à§Ò§í §ß§Ñ§é§Ñ§ä§î §Ù§Ñ§Ô§â§å§Ù§Ü§å!';
    $ru['ChkVerNotAvailable']='§¯§Ö §ß§Ñ§Û§Õ§Ö§ß§à §ß§à§Ó§à§Û §Ó§Ö§â§ã§Ú§Ú.';
    $ru['ChkVerError']='§°§ê§Ú§Ò§Ü§Ñ §á§à§Õ§Ü§Ý§ð§é§Ö§ß§Ú§ñ.';
    $ru['Website']='§³§Ñ§Û§ä';
    $ru['SendingForm']='§°§ä§á§â§Ñ§Ó§Ü§Ñ §æ§Ñ§Û§Ý§à§Ó; §á§à§Ø§Ñ§Ý§å§Û§ã§ä§Ñ, §á§à§Õ§à§Ø§Õ§Ú§ä§Ö';
    $ru['NoFileSel']='§¯§Ö§ä §Ó§í§Ò§â§Ñ§ß§ß§í§ç §æ§Ñ§Û§Ý§à§Ó';
    $ru['SelAll']='§£§í§Õ§Ö§Ý§Ú§ä§î §Ó§ã§Ö';
    $ru['SelNone']='§°§ä§Þ§Ö§ß§Ñ';
    $ru['SelInverse']='§°§Ò§â§Ñ§ä§Ú§ä§î §Ó§í§Ò§à§â';
    $ru['Selected_s']='§£§í§Ò§â§Ñ§ß(§í)';
    $ru['Total']='§£§ã§Ö§Ô§à';
    $ru['Partition']='§²§Ñ§Ù§Õ§Ö§Ý';
    $ru['RenderTime']='§³§Ü§â§Ú§á§ä §Ó§í§á§à§Ý§ß§Ö§ß §Ù§Ñ';
    $ru['Seconds']='§ã§Ö§Ü§å§ß§Õ';
    $ru['ErrorReport']='§°§ä§é§Ö§ä §à§Ò §à§ê§Ú§Ò§Ü§Ñ§ç';
    ...
    $et['ca']['NoDestDir'] = 'No s`ha seleccionat el directori de dest¨ª';
    $et['ca']['DestEqOrig'] = 'L`origen i el dest¨ª s¨®n iguals';
    $et['ca']['InvalidDest'] = 'El dest¨ª del directori ¨¦s inv¨¤lid';
    ...
    $et['ca']['ConfExec'] = 'Confirmar EXECUCI¨®';
    ...
    $et['ca']['InvPass'] = 'Clau inv¨¤lida';
    $et['ca']['ReadDenied'] = 'Acc¨¦s de lectura denegat';
    ...
    $et['ca']['ConfSaved'] = 'Configuraci¨® Desada';
    $et['ca']['PassSaved'] = 'Clau desada';
    $et['ca']['FileDirExists'] = 'Arxiu o directori ja existent';
    $et['ca']['NoPhpinfo'] = 'Funci¨® phpinfo() no habilitada';
    $et['ca']['NoReturn'] = 'sense retorn';
    $et['ca']['FileSent'] = 'Arxiu enviat';
    $et['ca']['SpaceLimReached'] = 'L¨ªmit d`espaci al disc assolit';
    $et['ca']['InvExt'] = 'Extensi¨® no v¨¤lida';
    ...
    $et['ca']['ChkVerAvailable'] = 'Nova versi¨®, feu clic aqu¨ª per descarregar';
    $et['ca']['ChkVerNotAvailable'] = 'La vostra versi¨® ¨¦s la m¨¦s recent.';
    $et['ca']['ChkVerError'] = 'Error de connexi¨®.';
